...
/*jstring Java_com_revesoft_checksignature_MyActivity_getToken(JNIEnv* env, jobject obj){

}*/

JNIEXPORT jstring JNICALL
Java_com_revesoft_checksignature_MainActivity_getToken(JNIEnv *env, jobject instance) {

    char* correctSign = "01457b8b64ce39d66ada82372893b444";
    //72eed157ba97751805fc2a3dfacea102
    //01457b8b64ce39d66ada82372893b444
    char* signMd5 = getSignatureMd5(env, instance);
    if(strcmp(signMd5, correctSign) == 0){
        return (*env)->NewStringUTF(env, "Token match");
    }else{
        return (*env)->NewStringUTF(env, "Token did not match!");
    }
}